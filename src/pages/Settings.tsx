...
export default function Settings() {
    ...
    const { currency, setCurrency, monthlyBudget, setMonthlyBudget, themeMode, setThemeMode } = useUIStore();
    ...
    // Theme is now managed by the Zustand store (themeMode, setThemeMode)
                    ...
                    {!accessToken ? (
                        ...
                        <>
                            {(window as any).Capacitor?.isNativePlatform ? (
                                <div className="text-xs text-slate-400 bg-background/50 rounded-lg px-4 py-3">
                                    <p className="font-medium text-foreground mb-1">Cloud backup not available in app</p>
                                    <p>Google Drive backup requires a browser. Please open FinTrack in Chrome or Edge on your computer to backup/restore data.</p>
                                </div>
                            ) : (
                                <>
